...
Structural-only. For behavioral anti-rules, see `conventions.md § Anti-Rules`.
...
- Do not create a separate top-level `Designs/` folder for active project design notes.
